...
public class PhoneBookManager3{
	...
	private static PhoneBookManager3 instance = null;
	public static final PhoneBookManager3 getInstance() {
		if(instance == null) {
			instance = new PhoneBookManager3();
		}
		return instance;
	}
	...
	public PhoneInfo insertData(int selNum, Scanner scan, PhoneInfo pBook) {
		switch (selNum) {
