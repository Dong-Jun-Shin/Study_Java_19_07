...
class PhoneUnivInfo extends PhoneInfo3{
...
class PhoneCompanyInfo extends PhoneInfo3{
...
public class PhoneInfo3 {
	...
	public PhoneInfo3(String name, String phoneNumber) {
		this.name = name;
	...
	public static void showPhoneInfo(PhoneInfo3 pBook) {
